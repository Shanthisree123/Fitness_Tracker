...
st.write("In this WebApp, you can observe your predicted calories burned. Pass your parameters such as Age, Gender, BMI, etc., and see the predicted value of kilocalories burned.") 
...
columns_to_keep = ["Gender", "Age", "BMI", "Duration", "Heart_Rate", "Body_Temp", "Calories"]
exercise_train_data = exercise_train_data[columns_to_keep]
exercise_test_data = exercise_test_data[columns_to_keep]
...
st.write("You have a higher heart rate than", round(sum(boolean_heart_rate) / len(boolean_heart_rate), 2) * 100, "% of other people.")
